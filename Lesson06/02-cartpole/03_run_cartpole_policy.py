"""Run CartPole in human render mode using a policy learned.

Run this script from the cart_pole_example directory after running one of the
REINFORCE notebooks.

Usage:
    python 06_run_cartpole_policy.py --episodes 3
    python 06_run_cartpole_policy.py --policy policy.pth
    python 06_run_cartpole_policy.py --delay 0.05
